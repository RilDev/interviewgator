...
_Note: String questions should be treated as array questions.You can use a method like `split` to convert it to an array and then retrun it as a string._
