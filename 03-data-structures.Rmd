...
// lookups in arrays are constant time, O(1), because the computer already know where the 3rd item is going to be since the array is squentially stored in memory.
...
So arrays are really good for lookup and pushes. But not so good for inserting in an other place than at the end of the array and deleting items from the array.
