...
Do not optimize your code prematurly. Optimizing for time or space could negatively impact readability which would be less that ideal in a start-up environment for instance.

A great engineer knows how to strike the right balance between run time, space and redability. If for instance the data past to a function is always small, a linear time algorithm might be better that a constant time algorithm.
