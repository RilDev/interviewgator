...
Everytime an element is looped in the first for loop, the entire array is looped in the second for loop. So we multiply `n` by itself: `O(n*n)` = `O(n^2)` (O of n square).
