...
Here is a quick wireframe of what I'm talking about: 

![Wireframe made with [wireframe.cc](https://wireframe.cc/){target="_blank"}](./assets/interviewgator-playground-wireframe.png)

<!-- [https://wireframe.cc/4LRTGu](https://wireframe.cc/4LRTGu){target="_blank"} -->
